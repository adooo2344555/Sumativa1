...
<template>
  ...
  <div class="h-screen flex flex-col">
     <!--navbar-->
     <header class="bg-yellow-500 text-white shadow-md fixed top-0 w-full z-50">
    ...
    <div class="flex mt-16">
        ...
        class="fixed md:relative top-0 left-0 h-[calc(100vh-64px)] w-64 bg-gray-700
         text-white transform transition-transform duration-300 ease-in-out shadow-lg z-40">
        <div class="px-4 text-xl font-semibold border-b border-blue-400 flex justify-between items-center">
            <span>MENU</span>
            <button @click="isSidebarOpen = false" class="md:hidden text-gray-300 hover:text-white">
        ...
        <nav class="mt-4">
            <ul>
                ...
                <li class="px-6 py-3 hover:bg-blue-500 flex items-center">
                    <Link :href="route('reservaciones.rango')" class="flex items-center w-full">
