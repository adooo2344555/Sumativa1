    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <h2 class="text-xl font-bold mb-4">Generar Reporte de Reservaciones</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label for="fechaInicio">Fecha Inicio</label>
                        <input type="date" id="fechaInicio" v-model="fechaInicio" class="w-full p-2 border rounded-md" />
                    </div>
                    <div>
                        <label for="fechaFinal">Fecha Final</label>
                        <input type="date" id="fechaFinal" v-model="fechaFinal" class="w-full p-2 border rounded-md" />
                    </div>

                    <div>
                        <label for="estado" class="block font-medium">Seleccione Estado</label>
                        <select id="estado" v-model="estado" class="w-full p-2 border rounded-md">
                    ...
                    <div>
                        <button @click="generarReporte" class="px-6 mt-4 bg-blue-600 hover:bg-blue-700 py-3 rounded-lg shadow-md text-white">
                            Generar PDF
                        </button>
                    </div>
                </div>
